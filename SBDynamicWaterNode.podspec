#
# Be sure to run `pod lib lint SBDynamicWaterNode.podspec' to ensure this is a
...
Physical water simulation for SpriteKit with demo application
  ...
  s.source           = { :git => "https://github.com/SteveBarnegren/DynamicWaterNode.git", :tag => s.version.to_s }
